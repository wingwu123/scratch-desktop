...
var ShardProcess = /** @class */ (function () {
    ...
    ShardProcess.prototype.spawn = function () {
        this.barrier.open();
    };
    ShardProcess.prototype.whenReady = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.info("whenReady begin ");
                        return [4 /*yield*/, this.barrier.wait()];
                    case 1:
                        _a.sent();
